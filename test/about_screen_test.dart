...
void main() {
  ...
  // The About screen is one long scroll of cards; give the test surface
  // enough height that every row is built (ListView virtualizes off-screen
  ...
  testWidgets('hero card and honesty cards render', (tester) async {
    ...
    expect(find.text('Transparent research'), findsOneWidget);
    expect(find.text('Built for more than cafes'), findsOneWidget);
  });

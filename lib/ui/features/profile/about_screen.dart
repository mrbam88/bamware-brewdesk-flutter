...
/// The About detail screen (brewdesk-flutter#32). Atly-style: the hero
/// card, honesty cards, and Support/Privacy/Terms/license/version rows used
/// to sit on the main You tab — they now live one level behind the About
/// nav row so the You tab itself stays a compact list.
